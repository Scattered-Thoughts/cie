    ...
    def parse(self):
        while self.token_index < len(self.tokens):
            ...
            if self.conditional_true:
                ...
                ErrorAndQuit('If conditionals were removed due to various errors. If you want to contribute to fixing them, go to https://github.com/Scattered-Thoughts/cie.')
